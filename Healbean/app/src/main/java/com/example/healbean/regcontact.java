...
public class regcontact extends AppCompatActivity {
                                ...
                                .addOnSuccessListener(new OnSuccessListener<Location>() {
                                    ...
                                    public void onSuccess(Location location) {
                                        if (location != null) {
                                            ...
                                            locate2.setText(lat + "," + longt);
                                            Toast.makeText(regcontact.this, "Success", Toast.LENGTH_SHORT).show();
                                        }
                                    }
                                });
                    } else {
            ...
            public void onClick(View view) {
                ...
                if(!TextUtils.isEmpty(sms) && !TextUtils.isEmpty(phoneNum)) {
                    if(checkPermission()) {
                        ...
                        Toast.makeText(regcontact.this, "Permission denied", Toast.LENGTH_SHORT).show();
                    }
                }
            }
        });
    ...
    private boolean checkPermission() {
        int result = ContextCompat.checkSelfPermission(regcontact.this, Manifest.permission.SEND_SMS);
        ...
        switch (requestCode) {
            case PERMISSION_REQUEST_CODE:
                if (grantResults.length > 0 && grantResults[0] == PackageManager.PERMISSION_GRANTED) {
                    ...
                    Toast.makeText(regcontact.this,
